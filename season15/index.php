...
<body>
    ...
    <section id="bottom">
        <section class="page clearfix">
            ...
            <br>
            <span class="">Event 1 – August 19, 2023 (FOG approved)</span>
            <!-- if completed, enter class="completed" -->
            <br>
            <span class="">Event 2 - September 23, 2023 (DATE CHANGED, FOG APPROVED)</span>
            <br>
            <span class="">Event 3 - SFDC - October 14, 2023 (FOG APPROVED)</span>
            <br>
            <span class="">Event 4 - November 11, 2023 (FOG APPROVED)</span>
            <br>
            <span class="">Event 5 – February 10, 2024 (FOG APPROVED)</span>
            <br>
            <span class="">Event 6 – March 9, 2024 (FOG APPROVED)</span>
            <br>
            <span class="">Event 7 – April 13, 2024 (FOG APPROVED)</span>
            <br>
            <span class="">Event 8 – May 11, 2024 (FOG APPROVED)</span>
            <br>
            <span class="">Free Roll – June 8, 2024 (FOG APPROVED)</span>
            <br>
            <br>
    ...
    <section id="top">
        <section class="page clearfix">
            <br />
            <br />
            <img src="images/season-15/season15champBeaver.png" />
    ...
    <section id="bottom">
        <section class="page clearfix">
            ...
            <p>
                ...
                <br />
                &bullet; There will be $9,000 chips for prepaid players after 4:00PM, up to 3 rounds. If no show after 3
                rounds, the chips will be taken away.
                <br />
                ...
                <br /><br />
                <b>Location for BAPS for Season 15</b>
                <br />
    ...
    <section id="top">
        <section class="page clearfix">
            <div class="box 1">
                ...
                <p>
                    BAPS is organized exclusively for the Deaf poker community and is open to any player in the ASL
    ...
    <footer>
        <section class="page" style="padding-top: 20px;">
            ...
            <div>&copy; Deaf Bay Area Poker Series - 2013&nbsp;&nbsp;&nbsp;<a
                    href="https://www.facebook.com/groups/bayareapokerseries/" target="_blank"><img
                        src="images/Facebook_icon.png" border="0" width="25" /></a></div>
            <br />
        </section>
    </footer>
