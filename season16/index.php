...
<body>
    <header>
        <section class="page clearfix">
            ...
            <nav id="main">
                ...
                <a href="downloads/season16/baps-season16-event8.pdf" target="_blank">Season 16 - Event 8</a>
    ...
    <section id="bottom">
        <section class="page clearfix">
            <br />
            <br />
            <img src="images/season-16/season16champSidansky.png" />
    ...
    <section id="top">
        <section class="page clearfix">
            ...
            <span class="completed">Event 8 – May 10, 2025
                <ul>
                    <li>
            ...
            <span class="next">Free Roll – June 7, 2025
                <ul>
                    <li>
    ...
    <section id="bottom">
        <section class="page clearfix">
            ...
            <p>
                ...
                <br /><br />
                <b>Location for BAPS for Season 16</b>
                <br />
    ...
    <section id="top">
        <section class="page clearfix">
            ...
            <div class="box 3 small">
                ...
                <br>
                <span class="completed">Event 8 – May 10, 2025 - <u>Face Cards Cracked</u></span>
                <br>
                <span class="next">Free Roll – June 7, 2025 - <u>Winner's Choice</u></span>
                <br>
            </div>
