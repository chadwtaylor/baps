...
<body>
    ...
    <section id="bottom">
        <section class="page clearfix">
            ...
            <span class="">Event 5 – Febrary 8, 2025
                <ul>
                    <li>
            ...
            <span class="">Event 7 – April 5, 2025
                <ul>
                    <li>
    ...
    <section id="top">
        <section class="page clearfix">
            <br />
            <br />
            <img src="images/season-16/season15champBeaver.png" />
    ...
    <section id="top">
        <section class="page clearfix">
            ...
            <div class="box 3 small">
                ...
                <br>
                <span class="">Event 5 – Febrary 8, 2025 - <u>Worst Hand</u></span>
                <br>
