...
<body>
	<header>
		<section class="page clearfix">
			...
			<nav id="main">
				...
				<a href="downloads/season12/BAPS-Guidelines-Season12.pdf" target="_blank">Guidelines - Season 12</a>
	...
	<section id="top">
		<section class="page clearfix">
			<br />
			<br />
			Furture seasons will be announced as soon as COVID-19 is cleared.
			<br />
			<br />
		</section>
	</section>
	...
	<section id="bottom">
		<section class="page clearfix">
            ...
            <br>
            <span class="">Event 7 – March 14, 2020 - CANCELLED</span>
            <br>
            <span class="">Event 8 – April 11, 2020 – CANCELLED</span>
            <br>
            <span class="">Event 9 – May 2, 2020 - CANCELLED</span>
            <br>
            <br>
            <h2>"Freeroll" ($20 entry fee)</h2>
            <span class="">June 13, 2020 - CANCELLED</span>
            <br>
		</section>
	</section>
	<section id="top">
