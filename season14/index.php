...
<body>
    ...
    <section id="bottom">
        <section class="page clearfix">
            ...
            <br>
            <span class="">Event 1 – August 20, 2022 (FOG approved)</span>
            <!-- if completed, enter class="completed" -->
            <br>
            <span class="">Event 2 - September 17, 2022 (FOG approved)</span>
            <br>
            <span class="">Event 3 - SFDC - October 8, 2022 (FOG approved)</span>
            <br>
            <span class="">Event 4 - November 12, 2022 (FOG approved)</span>
            <br>
            <span class="">Event 5 – February 11, 2023 (FOG approved)</span>
            <br>
            <span class="">Event 6 – March 11, 2023 (FOG approved)</span>
            <br>
